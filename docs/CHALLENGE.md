# DeFi Developer Challenge – Agentic Wallets for AI Agents
...
1. A working agentic wallet that can:
...
2. A deep dive explaining wallet design, security considerations, and how it interacts with AI agents (video or written)

3. Open-source code with clear README and setup instructions

4. Add a SKILLS.md file for agents to read

5. Working prototype on devnet is required
...
[Solana Docs](https://launch.solana.com/docs/kora/operators)
